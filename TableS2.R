...
s <- c("adults-DBHmax", "juvs-DBHmax", "adults-10cm", "juvs-10cm") # list of subsets
...
for(i in 1:4){
  my.dir <- paste0("quadrat-values-", s[i], "-2010/genus-inga/") # subset path
  ...
  my.dir <- paste0("trait-nulls-", s[i], "-2010/genus-inga/") # subset path for null
  list.all <- list.files(path = my.dir) # list files
  ...
  my.dir <- paste0("spatial-nulls-", s[i], "-2010/genus-inga/") # subset path for null
  list.all <- list.files(path = my.dir) # list files
